...
// The useQuery hook is used to fetch data from the API. It returns the data and a loading state. The data is automatically cached and invalidated when the query is refetched.

//the getAll query is used to fetch all guestbook entries.
